...
<div class="join">
	...
	<div class="tooltip" data-tip="Previous">
		...
		>
			<Icon name="left-bracket" width="24" height="24" class="h-6 w-6 fill-current md:h-8 md:w-8"></Icon>
		</a>
	</div>
	...
	<div class="tooltip" data-tip="Next">
		...
		>
			<Icon name="right-bracket" class="h-6 w-6 fill-current md:h-8 md:w-8"></Icon>
		</a>
	</div>
